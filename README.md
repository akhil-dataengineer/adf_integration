...
#ADF integration
=======
# usagm_databricks_test

The 'usagm_databricks_test' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] usagm_databricks_test_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/usagm_databricks_test.job.yml). The schedule
...
>>>>>>> 0b857b1 (Initial commit - add all project files)
